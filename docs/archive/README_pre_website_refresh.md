...
<p align="center">
  <img src="../assets/metriplane.png" alt="Metriplane" width="760">
</p>
...
<p align="center">
  <img src="../assets/Operator.png" alt="Metriplane Operator Dashboard" width="900">
</p>
...
Full runbook: [`docs/operator_ui_runbook.md`](../operator_ui_runbook.md) · Multi-camera setup: [`docs/dashboard_multicam_runbook.md`](../dashboard_multicam_runbook.md)
...
[`docs/sentinel.md`](../sentinel.md),
[`docs/contracts.md`](../contracts.md),
[`docs/command_center_dashboard.md`](../command_center_dashboard.md),
[`docs/camera_trust.md`](../camera_trust.md), and
[`docs/operator_assistant.md`](../operator_assistant.md).
...
Docs: [`docs/atlas/README.md`](../atlas/README.md).
...
<a href="https://www.youtube.com/watch?v=X4nyYcNFQhM">
  <img src="../assets/demo1.jpg" alt="Metriplane camera-first planar tracking demo" width="100%">
</a>
<br><b>Camera-first planar tracking</b>
</td>
<td width="50%" valign="top">
<a href="https://www.youtube.com/watch?v=q20j5-Owd4w">
  <img src="../assets/demo2.jpg" alt="Metriplane metric mapping demo" width="100%">
</a>
...
<a href="https://www.youtube.com/watch?v=xfuW-MVuphE">
  <img src="../assets/demo3.jpg" alt="Metriplane multi-camera fusion demo" width="100%">
</a>
<br><b>Multi-camera fusion</b>
</td>
<td width="50%" valign="top">
<a href="https://www.youtube.com/watch?v=tQvOO5kANqw">
  <img src="../assets/demo4.jpg" alt="Metriplane zone analytics demo" width="100%">
</a>
...
The benchmark evidence table is maintained in [`docs/eval/CANONICAL_EVIDENCE.md`](../eval/CANONICAL_EVIDENCE.md). For Paper B, the authoritative metric table is docs/eval/CANONICAL_EVIDENCE.md in release v0.1.3. Other summaries are non-authoritative convenience summaries. Benchmark claims are anchored to the public evidence campaign and direct artifacts listed below. Large JSONL sessions are not stored in Git; their hashes are recorded in [`evidence/manifest.csv`](../../evidence/manifest.csv).

| Benchmark result | Reported value | Direct artifact | Regenerate / verify |
|---|---:|---|---|
| Latency / update rate | 4,387 timing samples; detect.cam0 p95 1.242 ms; detect.cam1 p95 1.684 ms; fuse p95 0.184 ms; non-pacing pipeline p95 ≈3.55 ms | [`latency_summary.csv`](../../evidence/experiments/latency_summary.csv), [`latency_summary.md`](../eval/latency_summary.md) | `METRIPLANE_EVIDENCE_OUT=1 ./tools/mp.sh timing-breakdown` |
...
| CPU/GPU fusion performance | GPU backend correct but slower than CPU for tested N=1-1000 fusion-compute workloads; CPU remains default for current workloads | [`gpu_benchmark_001.csv`](../../evidence/experiments/gpu_benchmark_001.csv), [`gpu_summary.md`](../eval/gpu_summary.md) | `./tools/mp.sh gpu-benchmark` |
...
Schema documented in [`docs/schema.md`](../schema.md).
...
[`docs/isaac_omniverse_replay.md`](../isaac_omniverse_replay.md).
...
controller. See [`docs/ros2_bridge.md`](../ros2_bridge.md).
...
Full details: [`docs/PREREQUISITES.md`](../PREREQUISITES.md)
...
> **Note**: The `PYTEST_DISABLE_PLUGIN_AUTOLOAD=1` flag prevents conflicts with ROS 2 pytest plugins if installed system-wide. See [`docs/development.md`](../development.md) and [`docs/PREREQUISITES.md`](../PREREQUISITES.md) for troubleshooting details.
...
See [`docs/calibration_runbook.md`](../calibration_runbook.md) and [`docs/operator_ui_runbook.md`](../operator_ui_runbook.md).
...
| Document | Purpose |
|---|---|
| [`docs/PREREQUISITES.md`](../PREREQUISITES.md) | System requirements, dependency install |
| [`docs/development.md`](../development.md) | Dev setup, code quality, contribution guide |
| [`docs/calibration_runbook.md`](../calibration_runbook.md) | Camera calibration step-by-step |
| [`docs/operator_ui_runbook.md`](../operator_ui_runbook.md) | Web dashboard operator guide |
| [`docs/dashboard_multicam_runbook.md`](../dashboard_multicam_runbook.md) | Multi-camera dashboard setup |
| [`docs/physical_observability.md`](../physical_observability.md) | Architecture and claim boundaries |
| [`docs/object_registry.md`](../object_registry.md) | Named objects, types, tags, and registry loading |
| [`docs/trace_store.md`](../trace_store.md) | Trace summaries, speed/dwell/idle metrics, and exports |
| [`docs/events.md`](../events.md) | Operational event and alert schema |
| [`docs/contracts.md`](../contracts.md) | Sentinel spatial contract language |
| [`docs/sentinel.md`](../sentinel.md) | Observe-only Sentinel runtime |
| [`docs/command_center_dashboard.md`](../command_center_dashboard.md) | Command Center operator UI/API |
| [`docs/atlas/README.md`](../atlas/README.md) | Evidence workflow quickstart, protocol, domain packs, and limits |
| [`docs/schema.md`](../schema.md) | `FrameStateModel` v1.0 field reference |
| [`docs/frames.md`](../frames.md) | Coordinate systems: pixel, camera, world |
| [`docs/backpressure.md`](../backpressure.md) | Bounded queue design |
| [`docs/gpu_setup.md`](../gpu_setup.md) | CUDA / CuPy setup |
| [`docs/gpu_compute_backend.md`](../gpu_compute_backend.md) | GPU backend architecture |
| [`docs/INTEGRATIONS.md`](../INTEGRATIONS.md) | WebSocket, Omniverse, ROS 2 integration |
| [`docs/eval/evidence_matrix.md`](../eval/evidence_matrix.md) | Full evidence matrix with artifacts |
| [`docs/eval/evidence_index.md`](../eval/evidence_index.md) | Evidence summary and known limitations |
...
Measured results: [`docs/gpu_compute_backend.md`](../gpu_compute_backend.md) · [`evidence/experiments/gpu_benchmark_001.csv`](../../evidence/experiments/gpu_benchmark_001.csv)
...
- **Docs**: start with [`docs/PREREQUISITES.md`](../PREREQUISITES.md) for setup, [`docs/operator_ui_runbook.md`](../operator_ui_runbook.md) for the dashboard
