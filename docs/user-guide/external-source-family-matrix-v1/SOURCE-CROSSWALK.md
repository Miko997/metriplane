...
| ROS 2 / MCAP + TF2 | **NOT TESTED** | No adapter or tooling set selected or audited | No recording, message schema, calibration sidecar, or payload terms selected or inspected | No artifact, revision, path, or hash exists. MET-46 remains the future, separately authorized work item |
