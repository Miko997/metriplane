...
| ROS message definitions | Exact schema text is embedded in the synthetic recording and isolated adapter | Included only for the narrow synthetic profile. A future external source must identify every consumed schema and its terms. |
