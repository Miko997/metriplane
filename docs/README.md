...
- [Quickstart](user-guide/quickstart.md): install v0.4.0 and open the first
  Incident Report.
...
The package quickstart is for v0.4.0, the reduced Truth Recovery core release.
It has no DOI and does not establish a new research measurement boundary. See
