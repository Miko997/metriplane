...
The ordered node-id stream must contain exactly 2,443 items. In the exact core
environment above, without optional GPU extras and with the empty browser
cache, the integrated source profile has 2,427 passed and 16 expected skips.
