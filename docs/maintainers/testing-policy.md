...
The ordered node-id stream must contain exactly 6,117 items. In the exact core
environment above, without optional GPU extras and with the empty browser
cache, the integrated source profile requires 6,101 passed and 16 expected skips.
