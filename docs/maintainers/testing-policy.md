...
The ordered node-id stream must contain exactly 2,462 items. In the exact core
environment above, without optional GPU extras and with the empty browser
cache, the integrated source profile has 2,446 passed and 16 expected skips.
