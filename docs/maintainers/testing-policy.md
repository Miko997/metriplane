...
The ordered node-id stream must contain exactly 5,949 items. In the exact core
environment above, without optional GPU extras and with the empty browser
cache, the integrated source profile requires 5,934 passed and 15 expected skips.
