...
The ordered node-id stream must contain exactly 2,458 items. In the exact core
environment above, without optional GPU extras and with the empty browser
cache, the integrated source profile has 2,442 passed and 16 expected skips.
