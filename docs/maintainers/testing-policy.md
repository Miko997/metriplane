...
The ordered node-id stream must contain exactly 6,097 items. In the exact core
environment above, without optional GPU extras and with the empty browser
cache, the integrated source profile requires 6,082 passed and 15 expected skips.
