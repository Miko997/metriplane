...
fresh v0.4.0.post2 candidate cells recorded in the finalized release results.

Historical v0.3.0 WSL2 and native-Windows observations remain historical. They
must not be relabeled as v0.4.0.post2 validation or broadened into platform support.
...
v0.4.0.post2. Historical v2.5.x authority packets are not prerequisites or evidence
...
v0.4.0.post2 does not produce or replace the frozen SoftwareX evidence or historical
...
The manuscript at `10.2139/ssrn.7166858` is cited separately. No v0.4.0.post2 DOI
is claimed.
