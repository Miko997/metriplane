...
| Frozen research release and DOI | Use `v0.2.0` and DOI `10.5281/zenodo.20736619` only for the frozen SoftwareX research artifact; v0.4.0.post1 and v0.3.0 have no DOI and did not produce these results. The failed v0.4.0 tag has no DOI or published package. |
