...
EXPECTED_NAV = (
    ...
    "specs/cross-adapter-validation-audit-v1.md",
    "specs/cross-adapter-compatibility-gate-v1.md",
...
def test_v041_package_install_and_research_boundaries_are_truthful() -> None:
...
```"""
    ...
    assert 'python -m pip install "metriplane==0.4.1"' in troubleshooting
