...
def test_score_model_serializes():
    cs = CameraTrustScoreModel(
        camera_id="cam0", score=0.91, status="OK", dropout_rate=0.02, mean_disagreement_m=0.006
    )
...
def test_report_contains_cameras_and_recs():
    r = CameraTrustReportModel(
        run_id="r1",
        camera_scores={"cam0": CameraTrustScoreModel(camera_id="cam0", score=0.9, status="OK")},
