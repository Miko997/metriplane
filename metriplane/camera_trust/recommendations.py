...
if TYPE_CHECKING:
    ...
    from metriplane.camera_trust.models import CameraTrustScoreModel, ZoneCoverageScoreModel


def build_recommendations(
    camera_scores: dict[str, CameraTrustScoreModel],
    zone_scores: dict[str, ZoneCoverageScoreModel],
    config: CameraTrustConfig,
) -> list[str]:
    ...
    for cid, cs in sorted(camera_scores.items()):
        ...
        if (
            cs.mean_disagreement_m is not None
